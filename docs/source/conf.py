...
Notes:
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/infer-stack/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: infer_stack
            Set the Repository URL: https://github.com/AIQ-Kitware/infer_stack

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/infer-stack/integrations/create/
        ...
        Then go to
            ...
            https://github.com/AIQ-Kitware/infer_stack/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/infer-stack/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'infer_stack')
...
# html_logo = '.static/infer_stack.svg'
# html_favicon = '.static/infer_stack.ico'
...
man_pages = [
    (master_doc, 'infer_stack', 'infer_stack Documentation', [author], 1)
]
